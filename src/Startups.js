...
export default function Startups({ job }) {
        ...
        <Card className="mb-3">
            <Card.Body>
                <div className="d-flex justify-content-between">
                    <div>
                        <Card.Title>
                            Credit Suisse - <span className="text-muted font-weight-light">EMS</span>
                        </Card.Title>
                    ...
                    <img className="d-none d-md-block" height="50"  src="./Images/sample.png" />
                </div>
                <Card.Text>
                    <Button
